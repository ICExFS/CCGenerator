...
import ctypes
ctypes.windll.kernel32.SetConsoleTitleW(f"CC Generator | Made by ICE")
...
def main():
    ...
    / .'   \_| / .'   \_|
    | |        | |
    \ `.___.'\ \ `.___.'\  {Fore.LIGHTYELLOW_EX}Made by ICE {Fore.YELLOW}| {Fore.LIGHTMAGENTA_EX}.gg/4msAKsknVM {Fore.YELLOW}
     `.____ .'  `.____ .'
    '''
    print(sc)
    print()
